...
def plot_all_encounter_map_types(
    encounter_list, size=(50, 50), remove_map_number=False
...
def add_type_bar(
    type_list, figure, ax, pos=None, color_list=None, area_name=""
) -> Tuple[plt.Figure, plt.Axes]:
    letter_counts: Counter = Counter(type_list)
...
def show_level_scatter_plot(level_list):
    ...
    df.plot(
        ...
        y="Level",
        yticks=y_ticks,
        title="Level of Pokemons during the game",
        c="darkblue",
    )
    plt.yscale("linear")
